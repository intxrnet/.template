export default function TemplateItem3() {
  return (
    <div className="flex items-center justify-center w-full">
      <div className="flex flex-col items-center justify-center w-[40%]">
        ...
        <div>
          <p>
            <strong>YOU:</strong> Why are we here?
            <br />
            <strong>THE VOID:</strong> To discuss the migratory patterns of
            hypothetical penguins.
            <br />
            <strong>YOU:</strong> That makes no sense.
            <br />
            <strong>THE VOID:</strong> Exactly. Pass the marmalade.
          </p>
        </div>
        ...
        <ol type="I">
          <li>
            If a tree falls in a forest and no one hears it, ask it to write a
            sonnet.
          </li>
          <li>
            Befriend contradictions. Invite them to tea. Serve them stale
            biscuits.
          </li>
          <li>All truths are lies wearing hats. Tip your hat. Say nothing.</li>
        </ol>

        <p>
          <u>Ingredients:</u> One half-baked idea, two cups of paradox, a pinch
          of self-awareness. <u>Instructions:</u> Preheat the universe to 451°F.
          Whisk vigorously until frothy. Serve in a goblet carved from the
          fourth wall<sup>*</sup>. Consume while whistling the theme to{" "}
        ...
        <div>
          <p>
            <strong>Q:</strong> How many meta-narratives does it take to screw
            in a lightbulb?
            <br />
            <strong>A:</strong> The lightbulb is already aware of its role. It
            prefers the dark.
          </p>
        </div>
